...
هدف «فارسی رسمی‌تر» یا «متن زیباتر» نیست. هدف این است که متن فارسی طبیعی، دقیق، آرام، فنی و نزدیک به صدای همین repo بماند؛ بدون لحن بازاری، ترجمه‌ی لفظی، ادعای بزرگ‌تر از واقعیت، یا متن AI-like.
...
- `fa-voice.md`: صدای فارسی هدف و الگوهای جمله/ریتم.
