...
هدف پروژه ساخت «امن‌ترین پیام‌رسان ناشناس» یا وعده‌ی ناشناسی کامل نبود. هدف محدودتر و عملی‌تر بود: کم‌کردن داده‌ی ذخیره‌شده، شکستن رابطه‌های مستقیم میان storageها و توضیح صادقانه‌ی مرزهایی که هنوز وجود دارند.
