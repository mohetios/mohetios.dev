...
- public HTML یا صفحه marketing داخل Worker وجود ندارد.
- SPA یا dashboard جدا مسیر عملیاتی محصول نیست.
- متن پیام ناشناس در D1 transcript نمی‌شود.
- KV source of truth نیست.
- پیشنهاد گفت‌وگو بدون رضایت طرف مقابل گفت‌وگو نمی‌سازد.
- auto-match وجود ندارد.
- public profile وجود ندارد.
- پرداخت، اشتراک، boost و رتبه‌بندی پولی داخل هسته محصول نیستند.
...
- AI حکم نهایی نمی‌دهد؛ فقط برای embedding و کشف اولیه کمک می‌کند.
