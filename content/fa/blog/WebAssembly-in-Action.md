...
این یادداشت درباره کتاب **WebAssembly in Action** است؛ کتابی برای فهمیدن اینکه Wasm چطور کدهای زبان‌هایی مثل C، C++ و Rust را به محیط وب نزدیک می‌کند.

مسئله اصلی این نیست که WebAssembly جای JavaScript را بگیرد. مسئله این است که برای بخش‌های محاسباتی، پردازش سنگین یا کدهای موجود، یک مسیر قابل استفاده به مرورگر باز می‌کند.
