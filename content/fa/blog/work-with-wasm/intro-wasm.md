...
این برنامه کوچک یک پیام را در کنسول مرورگر چاپ می‌کند.
...
یک سرور محلی راه بیندازید، چون مرورگرها فایل‌های WASM را مستقیم از filesystem اجرا نمی‌کنند:
...
- این کد یک `div` جدید می‌سازد و پیامی را در صفحه نمایش می‌دهد.
