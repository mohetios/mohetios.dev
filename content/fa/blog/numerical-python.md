...
_Numerical Python_ بین برنامه‌نویسی و ریاضی کاربردی می‌نشیند. درباره استفاده از Python به‌عنوان محیط عملی برای آرایه، روش‌های عددی، visualization و workflow علمی است.
