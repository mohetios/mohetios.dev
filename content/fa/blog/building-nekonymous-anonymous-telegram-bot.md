...
در چند وقت گذشته تصمیم گرفتم نِکو را از آن ایده‌ی اولیه‌ی خام بیرون بیاورم و آن را از نظر معماری، کد، امنیت، failure handling و تجربه‌ی کاربری کاملاً بازسازی کنم.
...
برای همین وقتی اولین بار بات را start می‌کنید، به‌جای یک متن رسمی و طولانی با چنین چیزی روبه‌رو می‌شوید:
