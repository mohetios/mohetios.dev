...
2. پیشنهاد گفت‌وگو با ارزیابی سبک گفت‌وگو، نه ادعای هماهنگی دقیق.
...
```text
D1
→ کاربران، لینک‌ها، ارزیابی، پیشنهادهای گفت‌وگو، آمار تجمیعی روزانه

TicketVault Durable Object
→ sealed ticket: route_enc + payload_enc

UserState Durable Object
→ inbox pointers، پیش‌نویس‌ها، مسدودسازی‌ها، نام‌های خصوصی، جلسه ارزیابی
...
از نظر محصول، این بیشتر شبیه ترکیب چند سیگنال تقریبی است تا یک حکم قطعی. چند سیگنال از ارزیابی، چند فیلتر ایمنی، و یک رتبه‌بندی قابل توضیح کنار هم قرار می‌گیرند تا بگویند «این گزینه‌ها احتمالاً برای شروع گفت‌وگو نزدیک‌ترند»، نه اینکه «این دو نفر با هم هماهنگ‌اند».
...
ارزیابی هم برای برچسب‌زدن به شخصیت طراحی نشده. اسمش ارزیابی سبک گفت‌وگوست. یعنی سیگنال‌هایی درباره‌ی نحوه‌ی گفتگو، مرزها، عمق، ریتم پاسخ، مستقیم‌بودن، گرمی، تنظیم هیجان، و ترجیح‌های ارتباطی.
...
این دکمه‌ها مسیرهای اصلی را باز می‌کنند؛ اما خود تنظیمات، ارزیابی و پیشنهاد گفت‌وگو با inline keyboard جلو می‌روند. وقتی کاربر در حال نوشتن پیام، پاسخ، نام خصوصی، نام نمایشی یا معرفی کوتاه برای یک درخواست گفت‌وگو است، reply keyboard فقط «↩️ لغو» را نشان می‌دهد. این باعث می‌شود متن دکمه‌های منوی اصلی وسط draft با ورودی کاربر اشتباه گرفته نشود.
...
D1
→ کاربران، لینک‌ها، ارزیابی‌ها، پیشنهادهای گفت‌وگو، آمار تجمیعی در platform_daily_stats

TicketVaultDO
→ sealed ticket: route_enc و payload_enc

UserStateDO
→ inbox pointers، پیش‌نویس، مسدودسازی، نام خصوصی، جلسه ارزیابی
...
| تطابق شخصیتی یا هماهنگی دقیق      | پیشنهاد گفت‌وگو بر اساس ارزیابی سبک گفت‌وگو                         |
...
workflow پیشنهاد گفت‌وگو در D1 است؛ متن intro رمزنگاری‌شده.
